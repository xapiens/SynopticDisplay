...
// $Id: SquareWaveGenerator.java,v 1.3 2010/09/15 16:36:31 apetrov Exp $
...
@DisplayElement(
    ...
    icon            = "iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAABlBMVEX///8AAABVwtN+AAAAAXRSTlMA" +
                      "QObYZgAAABtJREFUeNpjYGBgrGFgZnvCxMCAC7E0/2eAAQBMbgMDo9wLaQAAAABJRU5ErkJggg==",
    designTimeView  = "gov.fnal.controls.applications.syndi.builder.element.variant.SimulationComponent",
    helpUrl         = "/SquareSimulatedSource",
...
public class SquareWaveGenerator extends AbstractGenerator {
    ...
    public void run() {
        ...
        double val = offset + amplitude *
                Math.signum( Math.sin( 1e-3 * (t - t0) / _period + _phase ));
