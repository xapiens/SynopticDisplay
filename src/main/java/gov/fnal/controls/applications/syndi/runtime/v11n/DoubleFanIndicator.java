...
// $Id: DoubleFanIndicator.java,v 1.4 2010/09/15 16:36:30 apetrov Exp $
...
public class DoubleFanIndicator extends AbstractShapeIndicator {
    ...
    private static Shape createOutline() {
        ...
        p.closePath();
        p.append( new Arc2D.Double( 0.33, 0, 0.33, 0.33, 0, 180, Arc2D.OPEN ), false );
        p.lineTo( 0.67, 0.84 );
        p.append( new Arc2D.Double( 0.33, 0.67, 0.33, 0.33, 0, -180, Arc2D.OPEN ), true );
        p.closePath();
        return p;
    }

    public DoubleFanIndicator() {
        super( createOutline());
    }
