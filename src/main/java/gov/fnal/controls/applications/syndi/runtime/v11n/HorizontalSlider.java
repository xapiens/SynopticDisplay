...
// $Id: HorizontalSlider.java,v 1.3 2010/09/15 16:36:30 apetrov Exp $
...
public class HorizontalSlider extends AbstractSlider {
    ...
    public HorizontalSlider() {
        ...
        add( display, new GridBagConstraints( 0, 0, 1, 1, 1.0, 0.0,
            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
            new Insets( 0, 0, 6, 0 ), 0, 0 ));
        add( slider,  new GridBagConstraints( 0, 1, 1, 1, 1.0, 1.0,
