...
// $Id: CompressorIndicator.java,v 1.3 2010/09/15 16:36:30 apetrov Exp $
...
@DisplayElement(
    ...
    name            = "Compressor",
    description     = "A compressor state indicator.",
...
public class CompressorIndicator extends AbstractShapeIndicator {
    
    private static Shape createOutline() {
        GeneralPath p = new GeneralPath();
        p.append( new Ellipse2D.Double( 0, 0.33, 0.67, 0.67 ), false );
        p.moveTo( 0.33, 0.33 );
        p.lineTo( 0.33, 0 );
        p.lineTo( 0.67, 0 );
        p.lineTo( 0.67, 0.67 );
